...
QT_MOC_LITERAL(1, 5, 16), // "deleteTaskSignal"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 2), // "id"
QT_MOC_LITERAL(4, 26, 14), // "editTaskSignal"
QT_MOC_LITERAL(5, 41, 10), // "deleteTask"
QT_MOC_LITERAL(6, 52, 8) // "editTask"

    },
    "Task\0deleteTaskSignal\0\0id\0editTaskSignal\0"
    "deleteTask\0editTask"
};
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::deleteTaskSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Task::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::editTaskSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Task::deleteTaskSignal(int _t1)
{
...
// SIGNAL 1
void Task::editTaskSignal(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
