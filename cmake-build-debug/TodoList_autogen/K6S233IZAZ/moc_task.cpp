...
QT_MOC_LITERAL(1, 5, 12), // "emitDeleteId"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 2), // "id"
QT_MOC_LITERAL(4, 22, 10) // "emitEditId"

    },
    "Task\0emitDeleteId\0\0id\0emitEditId"
};
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->emitDeleteId((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->emitEditId((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::emitDeleteId)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Task::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::emitEditId)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Task::emitDeleteId(int _t1)
{
